...
listOfActions.forEach((gameAction) => {
  ...
  action.addEventListener('click', () => {
    ...
    gameUiSub.modaltexto(`<div class="winfinaly" >ganó ${game.finallyWin} </div><div class="container" > <br> <div class="contadorUser"><p class="lifeUser"> vida de usuario: </p><p class="lifeUserSub">${game.getUserLife()}</div></p>
